...
def main():
    ...
    setup(
        ...
        description=("Python utilities used for interacting with JSON Files and Objects"),
        include_package_data=True,
        install_requires=install_requirements,
        keywords=["python", "libraries", "json"],
        license="MIT",
        long_description=readme,
        long_description_content_type='text/markdown',
        name="ctodd-python-lib-json",
        packages=packages,
        project_urls={},
        python_requires=">3.6",
        setup_requires=setup_requirements,
        tests_require=test_requirements,
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-json",
        version=version,
    )
